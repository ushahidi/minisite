        ...
        <div class="mdc-layout-grid__inner">
            <div class="mdc-layout-grid__cell--span-12">
                <div class="mdc-text-field">
                    <input value="{{$community->name}}" id="name" name="name" class="mdc-text-field__input @error('name') is-invalid @enderror" required>
            ...
            <div class="mdc-layout-grid__cell--span-12">
                <div class="mdc-text-field">
                    <input value="{{$community->welcome}}" id="welcome" name="welcome" class="mdc-text-field__input @error('welcome') is-invalid @enderror" required>
                    <div class="mdc-line-ripple"></div>
            ...
            <div class="mdc-layout-grid__cell--span-12">
                <div
                    ...
                    <textarea id="description" name="description" class="mdc-text-field__input" aria-labelledby="description" rows="6"
                        cols="40" maxlength="255" required>{{$community->description}}</textarea>
            ...
            <div class="mdc-layout-grid__cell--span-12">
                <div class="mdc-text-field">
                    <input value="{{$community->communityLocation->display_name ?? ''}}" id="location_string" name="location_string" class="mdc-text-field__input @error('location_string') is-invalid @enderror" required>
                    <div class="mdc-line-ripple"></div>
            ...
            <div class="mdc-layout-grid__cell--span-12">
                <div class="">
                    <div class="mdc-form-field">
                        <div class="mdc-radio">
                            <input {{$community->visibility === 'community' ? 'checked' : ''}} class="mdc-radio__native-control" type="radio" name="visibility" value="community" class="form-control @error('visibility') is-invalid @enderror" checked>
                    ...
                    <div class="mdc-form-field">
                        <div class="mdc-radio">
                            <input {{$community->visibility === 'public' ? 'checked' : ''}} class="mdc-radio__native-control" type="radio" name="visibility" value="public" class="form-control @error('visibility') is-invalid @enderror">
                            <div class="mdc-radio__background">
                            <div class="mdc-radio__outer-circle"></div>
                            <div class="mdc-radio__inner-circle"></div>
                            </div>
