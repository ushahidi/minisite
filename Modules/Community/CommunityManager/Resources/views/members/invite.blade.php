...
<div class="invite-members">
    <form method="POST" action="{{ route('community.members.invite.send', ['community' => $community]) }}">
    @csrf
        <div class="mdc-layout-grid__inner">
            <div class="mdc-layout-grid__cell--span-12">
                <div class="mdc-text-field text-field mdc-text-field--textarea">
                    <textarea id="member-emails" name="emails" class="mdc-text-field__input"></textarea>
            ...
            <div class="mdc-layout-grid__cell--span-12">
                <div class="mdc-text-field text-field mdc-text-field--textarea">
                    ...
                    <textarea name="message" id="invite-message" class="mdc-text-field__input" maxlength="200">Hi, 
I'd like to invite you to our community page.</textarea>
                    <div class="mdc-notched-outline mdc-notched-outline--upgraded">
                        <div class="mdc-notched-outline__leading"></div>
                        <div class="mdc-notched-outline__notch" style="">
